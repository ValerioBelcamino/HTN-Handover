...
state.objects = {'screwdriver', 'screwdriver2', 'box', 'box2', 'box3', 'dummy_tuck_objL', 'dummy_tuck_objR', 
                 'screws', 'brick1', 'brick6', 'brick7', 'brick4', 'brick3', 'brick2', 'brick5'}
...
state.locations = {'table', 'table2', 'tuck_positionL', 'tuck_positionR', 'exchange point', 'X', 'Y', 'workspace', 'workspaceL',
                    'brick1_pose', 'brick2_pose', 'brick3_pose','brick4_pose', 'brick5_pose', 'brick6_pose', 'brick7_pose',
                    'box_location', 'box2_location', 'box3_location'}
